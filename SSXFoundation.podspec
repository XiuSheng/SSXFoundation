#
# Be sure to run `pod lib lint SSXFoundation.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SSXFoundation.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'SSXFoundation' => ['SSXFoundation/Assets/*.png']
  # }
